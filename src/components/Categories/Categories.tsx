...
const getTransformedImage = (url: string, width = 400, height = 300) => {
  ...
  // This ensures the most important part of the image is always visible
  return url.replace(
    '/upload/',
    `/upload/w_${width},h_${height},c_fill,g_auto:face,q_auto:good,f_auto,dpr_auto/`
  );
};
...
const Categories: React.FC = () => {
  ...
  const CategorySkeleton = () => (
    <div className="bg-white border border-gray-100 overflow-hidden group cursor-pointer rounded-lg">
      <div className="aspect-[5/8] bg-gray-200 animate-pulse"></div>
      <div className="p-6">
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-20">
          <div className="inline-block mb-4">
            <span className="text-sm font-semibold text-red-600 tracking-wider uppercase bg-red-50 px-4 py-2 rounded-full">
              Collections
            </span>
          </div>
          ...
          {categoriesLoading
            ...
            : categoriesData.map((category) => (
                <div
                  ...
                  className="bg-white border border-gray-100 hover:border-gray-200 transition-all duration-300 overflow-hidden group cursor-pointer hover:shadow-xl rounded-lg transform hover:-translate-y-1"
                >
                  {/* Image Container with 5:8 Aspect Ratio (Portrait) */}
                  <div className="relative aspect-[5/8] overflow-hidden bg-gray-100">
                    {category.categoryImage ? (
                      <img
                        src={getTransformedImage(category.categoryImage, 400, 640)}
                        alt={category.name}
                    ...
                    {category.itemCount && (
                      <div className="absolute bottom-4 left-4 opacity-0 group-hover:opacity-100 transition-all duration-300">
                        <span className="bg-white/90 backdrop-blur-sm px-3 py-1 text-sm font-medium text-gray-900 rounded-full">
                  ...
                  {/* Content */}
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-red-600 transition-colors duration-200 line-clamp-1">
                      {category.name}
                    </h3>
          ...
          <div className="text-center py-16">
            <div className="text-gray-400 mb-4">
              <svg className="h-16 w-16 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M20 13V6a2 2 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2M4 13h2m0 0V9a2 2 0 012-2h2a2 2 0 012 2v4h-2m-6 0V9a2 2 0 012-2h2a2 2 0 012 2v4h-2" />
              </svg>
            </div>
        ...
        {!categoriesLoading && categoriesData.length > 0 && (
          <div className="text-center mt-16">
            <button
              ...
              className="bg-gray-900 text-white px-12 py-4 font-semibold hover:bg-gray-800 transition-all duration-200 transform hover:scale-[1.02] hover:shadow-lg border-2 border-transparent hover:border-gray-700 rounded-lg"
            >
              View All Categories
            </button>
          </div>
